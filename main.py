...
class MainWindow(object):
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.comp.setToolTip(_translate("MainWindow", "downloads audio + video streams"))
...
class MyWidget(QMainWindow, MainWindow):
    ...
    def initUI(self):
        ...
        self.clear_b.clicked.connect(self.canceling)
        self.clear_b_2.clicked.connect(self.clear_history)
        self.timer = QTimer()
    ...
    def clear_history(self):
        if self.try_open("YTD_list.db"):
            os.remove("YTD_list.db")
            self.history.clear()
    ...
    def start_bd(self):
        ...
        if len(dat) >= self.buffer_size.value() and not self.buffer_size.value() == 0:
